...
stats:
  ...
  - { value: "3", label: "Working Groups" }
  - { value: "AR6", label: "Latest Assessment Report (2023)" }
  - { value: "1.5°C", label: "Special Report that shaped Paris ambition" }
seeAlso:
  - { title: "The 1.5°C Threshold", category: "Concepts", description: "The temperature target that IPCC science gave teeth.", slug: "the-1-5-c-threshold" }
  - { title: "Paris Agreement", category: "Frameworks", description: "The treaty whose ambition is built on IPCC findings.", slug: "paris-agreement" }
  - { title: "UNFCCC and COP", category: "Actors", description: "The negotiation system that uses IPCC reports as its scientific baseline.", slug: "unfccc-and-cop" }
  - { title: "TCFD", category: "Frameworks", description: "The disclosure framework that traces back to IPCC climate scenarios.", slug: "tcfd" }
  - { title: "Physical Risks", category: "Concepts", description: "Direct climate damage defined and quantified through IPCC outputs.", slug: "physical-risks" }
unexpected:
