...
type: "article"
stats:
  - { value: "March 2021", label: "In effect (Level 1)" }
  - { value: "Art. 6/8/9", label: "Product classification tiers" }
  - { value: "PAIs", label: "Adverse impact reporting" }
  - { value: "Under review", label: "Labelling system as of 2025" }
seeAlso:
  - { title: "EU Taxonomy", category: "Frameworks", description: "The classification system that defines what counts as taxonomy-aligned under SFDR.", slug: "eu-taxonomy" }
  - { title: "CSRD", category: "Frameworks", description: "The corporate reporting directive that feeds data into SFDR disclosures.", slug: "csrd" }
  - { title: "Greenwashing", category: "Concepts", description: "The core problem SFDR was designed to address in investment markets.", slug: "greenwashing" }
  - { title: "Green Bonds", category: "Instruments", description: "A sustainable debt instrument frequently held in Article 8 and 9 funds.", slug: "green-bonds" }
  - { title: "Climate Finance", category: "Concepts", description: "The broader field SFDR regulates on the investment product side.", slug: "climate-finance" }
unexpected:
...
SFDR also introduces the concept of Principal Adverse Impacts (PAIs), the negative effects that investment decisions have on sustainability factors. Larger financial market participants must publish a PAI statement explaining how they identify and address the main adverse impacts of their portfolios on the environment (including [[GHG Scopes|greenhouse gas emissions]] and biodiversity) and social/employee matters.
