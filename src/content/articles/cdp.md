...
stats:
  ...
  - { value: "680+", label: "Financial institutions requesting disclosure (2022)" }
  - { value: "A to F", label: "Grading scale" }
  - { value: "3", label: "Themes: climate, forests, water" }
seeAlso:
  - { title: "Science Based Targets Initiative", category: "Actors", description: "CDP is a founding partner; SBTi-validated targets improve CDP scores.", slug: "science-based-targets-initiative" }
  - { title: "TCFD", category: "Frameworks", description: "The disclosure framework CDP's climate questionnaire is aligned with.", slug: "tcfd" }
  - { title: "GHG Scopes", category: "Concepts", description: "The emissions categories that underpin all CDP disclosures.", slug: "ghg-scopes" }
  - { title: "Climate Action 100+", category: "Actors", description: "Investor coalition that uses CDP data to assess corporate climate performance.", slug: "climate-action-100-plus" }
  - { title: "IFRS S1 and S2", category: "Frameworks", description: "The mandatory standards CDP's questionnaire increasingly maps to.", slug: "ifrs-s1-and-s2" }
unexpected:
