---
title: "The Greenium"
subtitle: "The lower yield, and therefore lower borrowing cost, that green bond issuers enjoy compared to equivalent conventional bonds from the same issuer."
category: "instruments"
type: "article"
stats:
  - { value: "0-20 bps", label: "Typical greenium range" }
  - { value: "Strongest", label: "In euro-denominated and European markets" }
  - { value: "ESG mandates", label: "Primary demand driver" }
  - { value: "Emerging", label: "'Brown discount' for high-carbon issuers" }
seeAlso:
  - { title: "Green Bonds", category: "Instruments", description: "The use-of-proceeds instruments where the greenium is most observed.", slug: "green-bonds" }
  - { title: "Sustainability-Linked Bonds", category: "Instruments", description: "Performance-linked bonds that may attract a similar but less established pricing benefit.", slug: "sustainability-linked-bonds" }
  - { title: "Greenwashing", category: "Concepts", description: "The risk that erodes the greenium by degrading label credibility.", slug: "greenwashing" }
  - { title: "Transition Risks", category: "Concepts", description: "Financial risks driving the 'brown discount' for high-carbon issuers.", slug: "transition-risks" }
  - { title: "EU Taxonomy", category: "Frameworks", description: "The classification system that strengthens the greenium in European markets.", slug: "eu-taxonomy" }
unexpected:
...
When investors are willing to accept a slightly lower return on a [[Green Bonds|green bond]] than they would demand on an otherwise identical conventional bond from the same issuer, the difference is called the greenium. The word is a portmanteau of "green" and "premium", though it functions as a discount from the borrower's perspective, since lower yields mean cheaper debt.
...
That argument has limits. The greenium is not guaranteed, it fluctuates with market conditions, and it depends critically on the credibility of the green label. A bond later found to be [[Greenwashing|greenwash]], proceeds misallocated, reporting absent, targets unambiguous, would erase any reputational benefit and potentially trigger [[Climate Litigation]] or regulatory action. The greenium, in other words, is not just free money: it carries obligations.
