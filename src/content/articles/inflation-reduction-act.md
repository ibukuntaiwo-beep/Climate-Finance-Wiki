...
type: "article"
stats:
  - { value: "Aug 2022", label: "Signed into law" }
  - { value: "~$394B", label: "Climate/energy funding over 10 years" }
  - { value: "~40%", label: "Projected GHG cut by 2030 vs 2005" }
  - { value: "40%", label: "Justice40 benefit target" }
seeAlso:
  - { title: "EU Green Deal", category: "Frameworks", description: "The EU's regulation-driven counterpart to the IRA's subsidy approach.", slug: "eu-green-deal" }
  - { title: "Paris Agreement", category: "Frameworks", description: "The international commitment the IRA helps advance.", slug: "paris-agreement" }
  - { title: "Just Transition", category: "Concepts", description: "The principle behind Justice40's focus on disadvantaged communities.", slug: "just-transition" }
  - { title: "Cap-and-Trade", category: "Instruments", description: "The carbon pricing approach the IRA largely avoided in favour of incentives.", slug: "cap-and-trade" }
  - { title: "Green Bonds", category: "Instruments", description: "A financing instrument the IRA's incentives have helped expand in the US.", slug: "green-bonds" }
unexpected:
