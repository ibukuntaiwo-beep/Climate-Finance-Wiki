...
type: "article"
stats:
  - { value: "$100B/yr", label: "Copenhagen climate finance pledge" }
  - { value: "~$83B", label: "Actually delivered by 2020" }
  - { value: "50%", label: "EIB climate action financing target (2025)" }
  - { value: "5+", label: "Major multilateral DFIs" }
seeAlso:
  - { title: "Climate Finance", category: "Concepts", description: "The broader field DFIs are a primary channel for.", slug: "climate-finance" }
  - { title: "Just Transition", category: "Concepts", description: "The social dimension DFIs must integrate into project design.", slug: "just-transition" }
  - { title: "UNFCCC and COP", category: "Actors", description: "The negotiation process where DFI finance pledges are contested.", slug: "unfccc-and-cop" }
  - { title: "Paris Agreement", category: "Frameworks", description: "The treaty DFIs have committed to align their portfolios with.", slug: "paris-agreement" }
  - { title: "Green Bonds", category: "Instruments", description: "A key instrument DFIs use to raise climate-directed capital.", slug: "green-bonds" }
unexpected:
