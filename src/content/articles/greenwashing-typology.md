---
title: "Greenwashing Typology"
subtitle: "A practical taxonomy of the six main patterns of misleading environmental communication, from hiding in crowds to blaming consumers."
category: "concepts"
type: "article"
stats:
  - { value: "6", label: "Distinct types" }
  - { value: "3", label: "EU regulatory responses (SFDR, Taxonomy, CSRD)" }
  - { value: "Growing", label: "Climate litigation case law" }
seeAlso:
  - { title: "Greenwashing", category: "Concepts", description: "The broader phenomenon these six patterns describe.", slug: "greenwashing" }
  - { title: "Net Zero vs Carbon Neutral", category: "Concepts", description: "A common greenlabeling flashpoint.", slug: "net-zero-vs-carbon-neutral" }
  - { title: "Climate Litigation", category: "Concepts", description: "Legal action increasingly targeting specific greenwashing patterns.", slug: "climate-litigation" }
  - { title: "Science Based Targets Initiative", category: "Frameworks", description: "Addresses greenrinsing by requiring public interim milestones.", slug: "science-based-targets-initiative" }
  - { title: "SFDR", category: "Frameworks", description: "EU regulation designed to make greenlabeling in financial products legally actionable.", slug: "sfdr" }
unexpected:
