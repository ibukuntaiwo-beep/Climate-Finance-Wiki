...
stats:
  ...
  - { value: "~400", label: "Companies assessed" }
  - { value: "16", label: "High-carbon sectors covered" }
  - { value: "2", label: "Dimensions: Management Quality + Carbon Performance" }
seeAlso:
  - { title: "Climate Action 100+", category: "Actors", description: "The investor engagement initiative that uses TPI data directly.", slug: "climate-action-100-plus" }
  - { title: "TCFD", category: "Frameworks", description: "The disclosure standard TPI evaluates companies against.", slug: "tcfd" }
  - { title: "IPCC", category: "Actors", description: "The source of the climate scenarios TPI benchmarks against.", slug: "ipcc" }
  - { title: "Paris Agreement", category: "Frameworks", description: "The treaty whose temperature targets define TPI's alignment benchmarks.", slug: "paris-agreement" }
  - { title: "Transition Risks", category: "Concepts", description: "The financial risks TPI's assessments help investors identify.", slug: "transition-risks" }
unexpected:
