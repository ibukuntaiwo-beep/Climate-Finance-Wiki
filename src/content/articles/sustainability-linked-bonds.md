...
subtitle: "Bonds whose financial terms (typically the interest rate) change depending on whether the issuer hits pre-agreed sustainability targets."
category: "instruments"
type: "article"
stats:
  - { value: "25 bps", label: "Typical coupon step-up for missed targets" }
  - { value: "2019", label: "Asset class debut" }
  - { value: "5", label: "SLBP governance pillars" }
  - { value: "Unrestricted", label: "Use of proceeds" }
seeAlso:
  - { title: "Green Bonds", category: "Instruments", description: "Use-of-proceeds bonds that ring-fence capital for environmental projects.", slug: "green-bonds" }
  - { title: "Transition Bonds", category: "Instruments", description: "Bonds for hard-to-abate sectors navigating decarbonisation.", slug: "transition-bonds" }
  - { title: "Greenwashing", category: "Concepts", description: "The risk of misleading environmental claims in financial products.", slug: "greenwashing" }
  - { title: "Greenwashing Typology", category: "Concepts", description: "A classification of selective disclosure and misleading framing tactics.", slug: "greenwashing-typology" }
  - { title: "The Greenium", category: "Instruments", description: "The lower borrowing cost associated with credibly labelled green bonds.", slug: "the-greenium" }
unexpected:
...
A sustainability-linked bond (SLB) flips the logic of a [[Green Bonds|green bond]] on its head. Instead of restricting where the money goes, an SLB holds the issuer accountable for where they end up. The proceeds can fund anything, general corporate purposes, capital expenditure, working capital. What changes is the cost of the debt itself.
...
The credibility of any SLB depends heavily on whether its KPIs are material (relevant to the issuer's core business), ambitious (in line with [[Science Based Targets Initiative|science-based targets]] rather than business-as-usual trajectories), and externally verified. An SLB where a company commits to a 5% emissions reduction over 10 years, when its sector peers are averaging 20%, is doing very little real work.
