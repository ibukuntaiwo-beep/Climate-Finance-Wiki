---
title: "Mark Carney and the Tragedy of the Horizon"
subtitle: "Mark Carney's 2015 speech reframed climate change as a systemic financial risk, and in doing so, helped launch an entirely new field of practice."
category: "actors"
type: "article"
stats:
  - { value: "Sep 2015", label: "Tragedy of the Horizon speech" }
  - { value: "2015", label: "TCFD established under Carney's FSB" }
  - { value: "$130T+", label: "GFANZ assets at peak" }
  - { value: "2013–2020", label: "Governor, Bank of England" }
seeAlso:
  - { title: "TCFD", category: "Frameworks", description: "The disclosure framework Carney created through the Financial Stability Board.", slug: "tcfd" }
  - { title: "GFANZ", category: "Actors", description: "The net-zero finance alliance Carney co-chaired at COP26.", slug: "gfanz" }
  - { title: "UNFCCC and COP", category: "Actors", description: "The international climate process where Carney served as UN Special Envoy.", slug: "unfccc-and-cop" }
  - { title: "Stranded Assets", category: "Concepts", description: "A concept whose prominence traces back to the Tragedy of the Horizon moment.", slug: "stranded-assets" }
  - { title: "Transition Risks", category: "Concepts", description: "Financial risks from the shift to a low-carbon economy, framed by Carney's speech.", slug: "transition-risks" }
  - { title: "Physical Risks", category: "Concepts", description: "Direct climate damage risks that Carney argued markets were systematically underpricing.", slug: "physical-risks" }
unexpected:
