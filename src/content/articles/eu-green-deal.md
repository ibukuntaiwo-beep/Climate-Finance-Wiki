...
type: "article"
stats:
  - { value: "Dec 2019", label: "Announced" }
  - { value: "55%", label: "2030 GHG reduction target vs 1990" }
  - { value: "EUR 1T+", label: "Investment committed 2021-2030" }
  - { value: "2050", label: "Climate neutrality deadline (legally binding)" }
seeAlso:
  - { title: "EU Taxonomy", category: "Frameworks", description: "The classification system that defines what counts as green under the Deal.", slug: "eu-taxonomy" }
  - { title: "CSRD", category: "Frameworks", description: "The mandatory sustainability reporting directive enacted under the Deal.", slug: "csrd" }
  - { title: "Cap-and-Trade", category: "Instruments", description: "The EU ETS carbon market expanded significantly under Fit for 55.", slug: "cap-and-trade" }
  - { title: "Just Transition", category: "Concepts", description: "The principle embedded in the Deal's Social Climate Fund and transition mechanisms.", slug: "just-transition" }
  - { title: "Inflation Reduction Act", category: "Frameworks", description: "The US counterpart, subsidy-driven rather than regulation-driven.", slug: "inflation-reduction-act" }
unexpected:
