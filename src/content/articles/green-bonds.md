---
title: "Green Bonds"
subtitle: "Bonds that ring-fence their proceeds exclusively for environmental projects, with transparent reporting requirements before and after issuance."
category: "instruments"
type: "article"
stats:
  - { value: "$5.4T+", label: "Cumulative thematic bond issuance by Q3 2024" }
  - { value: "2014", label: "Green Bond Principles first published" }
  - { value: "4", label: "Pillars of governance" }
  - { value: "6", label: "Eligible project categories" }
seeAlso:
  - { title: "The Greenium", category: "Instruments", description: "The lower borrowing cost green bond issuers enjoy over conventional bonds.", slug: "the-greenium" }
  - { title: "Sustainability-Linked Bonds", category: "Instruments", description: "Bonds whose financial terms change based on issuer-level sustainability targets.", slug: "sustainability-linked-bonds" }
  - { title: "Transition Bonds", category: "Instruments", description: "Bonds for hard-to-abate sectors that cannot easily qualify for a green label.", slug: "transition-bonds" }
  - { title: "Green Bond Principles", category: "Frameworks", description: "The voluntary ICMA framework governing green bond issuance.", slug: "green-bond-principles" }
  - { title: "Greenwashing", category: "Concepts", description: "The risk of misleading environmental claims attached to financial products.", slug: "greenwashing" }
unexpected:
