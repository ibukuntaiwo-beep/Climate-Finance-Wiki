...
type: "article"
stats:
  - { value: "1990s", label: "Originated in trade union movements" }
  - { value: "Paris Agreement", label: "Referenced in preamble" }
  - { value: "Recurring", label: "Theme in UNFCCC/COP negotiations" }
  - { value: "Growing", label: "DFI social safeguard requirements" }
seeAlso:
  - { title: "Transition Risks", category: "Concepts", description: "The financial risks that just transition policy seeks to manage at a societal level.", slug: "transition-risks" }
  - { title: "Stranded Assets", category: "Concepts", description: "Assets rendered unviable by the low-carbon shift, with human costs attached.", slug: "stranded-assets" }
  - { title: "Development Finance Institutions", category: "Actors", description: "The primary vehicles for financing just transition in developing countries.", slug: "development-finance-institutions" }
  - { title: "Paris Agreement", category: "Frameworks", description: "The international treaty whose preamble enshrines just transition.", slug: "paris-agreement" }
  - { title: "Transition Bonds", category: "Instruments", description: "Debt instruments designed to fund the kind of industrial transformation just transition requires.", slug: "transition-bonds" }
unexpected:
