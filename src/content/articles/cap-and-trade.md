---
title: "Cap-and-Trade"
subtitle: "A compliance system where a government caps total emissions, issues tradeable permits up to that limit, and lets the market determine who reduces and who pays."
category: "instruments"
type: "article"
stats:
  - { value: "2005", label: "EU ETS launched" }
  - { value: "~40%", label: "EU GHG emissions covered by EU ETS" }
  - { value: "EUR 90+/t", label: "EU allowance price peak (2023)" }
  - { value: "4 major", label: "Systems worldwide (EU, California-Quebec, RGGI, China)" }
seeAlso:
  - { title: "Carbon Offsets", category: "Instruments", description: "Voluntary market certificates, distinct from compliance allowances.", slug: "carbon-offsets" }
  - { title: "Transition Risks", category: "Concepts", description: "Financial risks from rising carbon prices for high-emitting companies.", slug: "transition-risks" }
  - { title: "Stranded Assets", category: "Concepts", description: "Assets that lose value as carbon prices rise.", slug: "stranded-assets" }
  - { title: "EU Green Deal", category: "Frameworks", description: "The broader EU decarbonisation policy framework within which the ETS operates.", slug: "eu-green-deal" }
  - { title: "Article 6", category: "Frameworks", description: "The Paris Agreement framework for international carbon market cooperation.", slug: "article-6" }
unexpected:
