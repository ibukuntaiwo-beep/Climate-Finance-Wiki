...
stats:
  ...
  - { value: "7,000+", label: "Companies engaged globally" }
  - { value: "1.5°C", label: "Required warming limit for validation" }
  - { value: "2021", label: "Corporate Net Zero Standard launched" }
seeAlso:
  - { title: "CDP", category: "Actors", description: "A founding partner whose scoring rewards SBTi-validated targets.", slug: "cdp" }
  - { title: "Net Zero vs Carbon Neutral", category: "Concepts", description: "The distinction SBTi's Net Zero Standard was built to enforce.", slug: "net-zero-vs-carbon-neutral" }
  - { title: "GHG Scopes", category: "Concepts", description: "The emissions categories that structure SBTi's validation requirements.", slug: "ghg-scopes" }
  - { title: "Carbon Offsets", category: "Instruments", description: "The mechanism SBTi restricts to prevent companies from buying their way to net zero.", slug: "carbon-offsets" }
  - { title: "Greenwashing", category: "Concepts", description: "The credibility problem SBTi was designed to address.", slug: "greenwashing" }
  - { title: "Paris Agreement", category: "Frameworks", description: "The treaty whose temperature targets define SBTi's validation criteria.", slug: "paris-agreement" }
unexpected:
