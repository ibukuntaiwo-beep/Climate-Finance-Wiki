...
type: "article"
stats:
  - { value: "Nov 2021", label: "Launched at COP26" }
  - { value: "450+", label: "Member firms at peak" }
  - { value: "$130T+", label: "Assets represented at peak" }
  - { value: "2025", label: "Restructured into Principals Group" }
seeAlso:
  - { title: "Mark Carney and the Tragedy of the Horizon", category: "Actors", description: "Co-chair of GFANZ and architect of the net-zero finance moment.", slug: "mark-carney" }
  - { title: "UNFCCC and COP", category: "Actors", description: "The COP26 event where GFANZ was launched.", slug: "unfccc-and-cop" }
  - { title: "Science Based Targets Initiative", category: "Actors", description: "The validation standard GFANZ members were expected to use.", slug: "science-based-targets-initiative" }
  - { title: "Climate Action 100+", category: "Actors", description: "The engagement initiative GFANZ members used to pressure portfolio companies.", slug: "climate-action-100-plus" }
  - { title: "TCFD", category: "Frameworks", description: "The reporting framework GFANZ members committed to use.", slug: "tcfd" }
  - { title: "Greenwashing", category: "Concepts", description: "The credibility risk that dogged GFANZ from its launch.", slug: "greenwashing" }
unexpected:
