...
type: "article"
stats:
  - { value: "~50,000", label: "Companies in scope" }
  - { value: "Dec 2022", label: "Adopted" }
  - { value: "Double", label: "Materiality standard" }
  - { value: "FY2024", label: "First reports due" }
seeAlso:
  - { title: "EU Taxonomy", category: "Frameworks", description: "The classification system whose alignment KPIs companies must report under CSRD.", slug: "eu-taxonomy" }
  - { title: "SFDR", category: "Frameworks", description: "The investment product disclosure regime that relies on CSRD data.", slug: "sfdr" }
  - { title: "IFRS S1 and S2", category: "Frameworks", description: "The global alternative using single materiality rather than CSRD's double materiality.", slug: "ifrs-s1-s2" }
  - { title: "GHG Scopes", category: "Concepts", description: "The emissions categories CSRD requires companies to disclose.", slug: "ghg-scopes" }
  - { title: "Greenwashing", category: "Concepts", description: "The risk CSRD's mandatory assurance requirements are designed to reduce.", slug: "greenwashing" }
unexpected:
