...
type: "article"
stats:
  - { value: "197", label: "Parties (every country on Earth)" }
  - { value: "1987", label: "Adopted" }
  - { value: "~1°C", label: "Warming reduced" }
  - { value: "$4B+", label: "Multilateral Fund disbursed" }
seeAlso:
  - { title: "Kyoto Protocol", category: "Frameworks", description: "The first binding climate treaty, which lacked Montreal's universal participation.", slug: "kyoto-protocol" }
  - { title: "Paris Agreement", category: "Frameworks", description: "The current global climate framework that Montreal's governance model informs.", slug: "paris-agreement" }
  - { title: "UNFCCC and COP", category: "Actors", description: "The climate negotiation architecture that contrasts with Montreal's focused approach.", slug: "unfccc-and-cop" }
  - { title: "The 1.5C Threshold", category: "Concepts", description: "The temperature target the Kigali Amendment helps protect.", slug: "the-1-5-c-threshold" }
  - { title: "Just Transition", category: "Concepts", description: "The principle Montreal embedded through its Multilateral Fund for developing countries.", slug: "just-transition" }
unexpected:
...
Climate scientists estimate that full implementation of the Kigali Amendment could avoid up to 0.5 degrees Celsius of warming by 2100, making it one of the most impactful single actions available for limiting warming toward [[The 1.5°C Threshold|1.5°C]]. Combined with the Protocol's original ozone work (which also avoided significant warming, since CFCs are themselves greenhouse gases), the Montreal Protocol is estimated to have reduced global warming by up to 1 degree Celsius. It has arguably done more for the climate than the [[Kyoto Protocol]].
