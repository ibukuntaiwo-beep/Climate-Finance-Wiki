...
type: "article"
stats:
  - { value: "COP29", label: "Rules finalised (Baku, Nov 2024)" }
  - { value: "6.2 / 6.4", label: "Two distinct mechanisms" }
  - { value: "ITMOs", label: "Bilateral credit unit" }
  - { value: "2025-26", label: "First credits expected" }
seeAlso:
  - { title: "Paris Agreement", category: "Frameworks", description: "The treaty Article 6 sits within.", slug: "paris-agreement" }
  - { title: "Kyoto Protocol", category: "Frameworks", description: "The predecessor treaty whose CDM Article 6.4 replaces.", slug: "kyoto-protocol" }
  - { title: "Carbon Offsets", category: "Instruments", description: "The broader crediting landscape Article 6 intersects with.", slug: "carbon-offsets" }
  - { title: "Cap-and-Trade", category: "Instruments", description: "The carbon pricing mechanism Article 6 complements at the international level.", slug: "cap-and-trade" }
  - { title: "UNFCCC and COP", category: "Actors", description: "The negotiation architecture where Article 6 rules were hammered out.", slug: "unfccc-and-cop" }
unexpected:
