...
type: "article"
stats:
  - { value: "1992", label: "UNFCCC adopted" }
  - { value: "198", label: "Parties" }
  - { value: "COP21", label: "Produced the Paris Agreement (2015)" }
  - { value: "$100B/yr", label: "Climate finance pledge (Copenhagen, 2009)" }
seeAlso:
  - { title: "Paris Agreement", category: "Frameworks", description: "The legally binding framework produced at COP21.", slug: "paris-agreement" }
  - { title: "IPCC", category: "Actors", description: "The scientific body whose findings set the baseline for COP negotiations.", slug: "ipcc" }
  - { title: "GFANZ", category: "Actors", description: "The financial alliance launched at COP26 in Glasgow.", slug: "gfanz" }
  - { title: "Mark Carney and the Tragedy of the Horizon", category: "Actors", description: "The key architect of the finance turn at COP26.", slug: "mark-carney" }
  - { title: "Article 6", category: "Frameworks", description: "The carbon market rules negotiated through the COP process.", slug: "article-6" }
  - { title: "Greenwashing", category: "Concepts", description: "The performative ambition risk that is acute around COP events.", slug: "greenwashing" }
unexpected:
