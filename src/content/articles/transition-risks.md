...
subtitle: "The financial risks that arise not from climate change itself, but from the economic, policy, and social shifts required to move to a low-carbon economy."
category: "concepts"
type: "article"
stats:
  - { value: "4", label: "Risk categories" }
  - { value: "2015", label: "Carney's landmark speech" }
  - { value: "Growing", label: "Climate litigation cases" }
  - { value: "Path-dependent", label: "Severity varies by transition speed" }
seeAlso:
  - { title: "Physical Risks", category: "Concepts", description: "The financial damage caused directly by climate change impacts.", slug: "physical-risks" }
  ...
  - { title: "Climate Litigation", category: "Concepts", description: "Legal action driven by climate misrepresentation or inadequate action.", slug: "climate-litigation" }
  - { title: "Greenwashing", category: "Concepts", description: "Misleading claims about environmental credentials, a major reputational risk vector.", slug: "greenwashing" }
  - { title: "Just Transition", category: "Concepts", description: "Ensuring decarbonisation costs do not fall disproportionately on vulnerable workers and communities.", slug: "just-transition" }
unexpected:
...
**Technological risk** arises when new low-emission technologies displace existing ones faster than expected, or more expensively than planned. A utility that built coal capacity assuming a 40-year operating life may find that asset [[Stranded Assets|stranded]] within 15 years by cheaper solar and wind. Conversely, a company that bets heavily on a specific clean technology that fails to scale also faces transition risk.
