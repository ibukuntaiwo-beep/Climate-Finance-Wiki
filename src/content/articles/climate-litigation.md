...
type: "article"
stats:
  - { value: "2x", label: "Case count doubled since Paris Agreement" }
  - { value: "2", label: "Dominant patterns (washing + taps)" }
  - { value: "4+", label: "Legal theories deployed" }
  - { value: "Growing", label: "Financial institution exposure" }
seeAlso:
  - { title: "Greenwashing", category: "Concepts", description: "The misleading claims that climate-washing cases target.", slug: "greenwashing" }
  - { title: "Greenwashing Typology", category: "Concepts", description: "The six patterns of misleading environmental communication that courts are developing case law around.", slug: "greenwashing-typology" }
  - { title: "Transition Risks", category: "Concepts", description: "Legal risk is a formal category of transition risk.", slug: "transition-risks" }
  - { title: "Net Zero vs Carbon Neutral", category: "Concepts", description: "A distinction at the heart of many climate-washing cases.", slug: "net-zero-vs-carbon-neutral" }
  - { title: "TCFD", category: "Frameworks", description: "Requires disclosure of climate-related legal risk.", slug: "tcfd" }
unexpected:
