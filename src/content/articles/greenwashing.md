---
title: "Greenwashing"
subtitle: "Making misleading claims (through action, omission, or emphasis) about the environmental credentials of a product, strategy, or organisation."
category: "concepts"
type: "article"
stats:
  - { value: "1980s", label: "Term originated" }
  - { value: "Fastest-growing", label: "Climate-washing litigation" }
  - { value: "SFDR + Taxonomy", label: "EU regulatory response" }
  - { value: "Both ends", label: "Regulators pursue fraud and carelessness" }
seeAlso:
  - { title: "Greenwashing Typology", category: "Concepts", description: "The detailed taxonomy of greenwashing types, greencrowding, greenlighting, greenshifting, and more.", slug: "greenwashing-typology" }
  - { title: "Net Zero vs Carbon Neutral", category: "Concepts", description: "The distinction most commonly exploited in greenwashing claims.", slug: "net-zero-vs-carbon-neutral" }
  - { title: "Climate Litigation", category: "Concepts", description: "Legal action targeting false or misleading climate marketing claims.", slug: "climate-litigation" }
  - { title: "SFDR", category: "Frameworks", description: "The EU regulation requiring sustainable investment products to meet specific criteria.", slug: "sfdr" }
  - { title: "EU Taxonomy", category: "Frameworks", description: "The EU standard for what economic activities qualify as environmentally sustainable.", slug: "eu-taxonomy" }
unexpected:
...
The detailed taxonomy of greenwashing types, greencrowding, greenlighting, greenshifting, and so on, is covered in [[Greenwashing Typology]]. That article also addresses the reverse phenomenon: [[Greenwashing Typology|greenhushing]], where organisations deliberately downplay legitimate sustainability activities to avoid scrutiny.
