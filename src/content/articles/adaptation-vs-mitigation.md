...
type: "article"
stats:
  - { value: ">90%", label: "Climate finance flows to mitigation" }
  - { value: "~5%", label: "Climate finance flows to adaptation" }
  - { value: "1.5-2°C", label: "Beyond which adaptation hits hard limits" }
seeAlso:
  - { title: "Physical Risks", category: "Concepts", description: "The climate impacts that adaptation seeks to manage.", slug: "physical-risks" }
  - { title: "The 1.5°C Threshold", category: "Concepts", description: "The temperature boundary beyond which adaptation limits are crossed.", slug: "the-1.5c-threshold" }
  - { title: "Climate Finance", category: "Concepts", description: "The broader funding landscape where adaptation is chronically under-resourced.", slug: "climate-finance" }
  - { title: "Development Finance Institutions", category: "Actors", description: "The primary vehicle for mobilising adaptation finance in developing countries.", slug: "development-finance-institutions" }
  - { title: "UNFCCC and COP", category: "Actors", description: "Where adaptation finance gaps are most contested between nations.", slug: "unfccc-and-cop" }
unexpected:
...
A critical concept in climate science and policy is that adaptation is not infinitely scalable. Beyond certain temperature thresholds, particularly beyond [[The 1.5°C Threshold|1.5–2°C of warming]], some physical impacts become impossible or economically infeasible to adapt to. Entire island nations may become uninhabitable. Productive agricultural zones may shift irreversibly. Extreme heat may make outdoor work physiologically impossible in some regions for large parts of the year.
