...
type: "article"
stats:
  - { value: "20-25%", label: "Share of global CO2 from hard-to-abate sectors" }
  - { value: "2020", label: "ICMA Transition Finance Handbook published" }
  - { value: "No standard", label: "Universal taxonomy status as of 2024" }
  - { value: "~8%", label: "Steel's share of global CO2 emissions" }
seeAlso:
  - { title: "Green Bonds", category: "Instruments", description: "Use-of-proceeds bonds for clearly green projects.", slug: "green-bonds" }
  - { title: "Sustainability-Linked Bonds", category: "Instruments", description: "Bonds that hold issuers accountable for company-level sustainability targets.", slug: "sustainability-linked-bonds" }
  - { title: "Greenwashing", category: "Concepts", description: "The risk of misleading claims, especially acute where standards are absent.", slug: "greenwashing" }
  - { title: "Just Transition", category: "Concepts", description: "The social dimension of decarbonising high-carbon industries and communities.", slug: "just-transition" }
  - { title: "Transition Pathway Initiative", category: "Frameworks", description: "Sector-specific benchmarks for assessing transition plan ambition.", slug: "transition-pathway-initiative" }
unexpected:
...
The [[Paris Agreement]] provides a directional reference, transition activities should be consistent with a pathway to limiting warming to [[The 1.5°C Threshold|1.5°C]]. The [[Science Based Targets Initiative]] and [[Transition Pathway Initiative]] both offer sector-specific benchmarks that issuers and investors can use to assess whether a transition plan is genuinely ambitious. But neither was designed primarily around bond market mechanics.
