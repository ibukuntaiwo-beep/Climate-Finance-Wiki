...
type: "article"
stats:
  - { value: "2014", label: "First published by ICMA" }
  - { value: "4 pillars", label: "Core requirements" }
  - { value: "$500B+", label: "Annual green bond issuance by mid-2020s" }
  - { value: "Voluntary", label: "Compliance basis" }
seeAlso:
  - { title: "Green Bonds", category: "Instruments", description: "The debt instrument the Principles define and govern.", slug: "green-bonds" }
  - { title: "Sustainability-Linked Bonds", category: "Instruments", description: "A distinct instrument where terms are tied to targets, not use of proceeds.", slug: "sustainability-linked-bonds" }
  - { title: "Greenium", category: "Concepts", description: "The pricing premium green bonds sometimes command, and the incentive to mislabel.", slug: "greenium" }
  - { title: "EU Taxonomy", category: "Frameworks", description: "The classification system the EU Green Bond Standard requires full alignment with.", slug: "eu-taxonomy" }
  - { title: "Greenwashing", category: "Concepts", description: "The risk at the heart of green bond credibility debates.", slug: "greenwashing" }
unexpected:
