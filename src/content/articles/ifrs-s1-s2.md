...
type: "article"
stats:
  - { value: "June 2023", label: "Published" }
  - { value: "ISSB", label: "Issuing body" }
  - { value: "Scope 1-3", label: "Emissions disclosure required" }
  - { value: "IOSCO", label: "Endorsed by" }
seeAlso:
  - { title: "TCFD", category: "Frameworks", description: "The predecessor framework whose four-pillar structure S2 directly adopted.", slug: "tcfd" }
  - { title: "CSRD", category: "Frameworks", description: "The EU's parallel standard using double materiality rather than ISSB's single materiality.", slug: "csrd" }
  - { title: "GHG Scopes", category: "Concepts", description: "The emissions categories S2 requires companies to disclose.", slug: "ghg-scopes" }
  - { title: "Physical Risks", category: "Concepts", description: "Climate risks that must be assessed under S2.", slug: "physical-risks" }
  - { title: "Transition Risks", category: "Concepts", description: "Financial consequences of decarbonisation that S2 requires disclosure on.", slug: "transition-risks" }
unexpected:
...
On metrics, S2 requires disclosure of [[GHG Scopes|Scope 1, Scope 2, and Scope 3]] emissions. For financial institutions specifically, it requires disclosure of financed emissions, the [[GHG Scopes|Scope 3]] emissions attributable to a bank's or asset manager's lending and investment portfolio. This is a significant expansion compared to TCFD, which treated Scope 3 as optional in most cases.
