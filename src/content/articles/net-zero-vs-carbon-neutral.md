...
type: "article"
stats:
  - { value: "90–95%", label: "Reduction required for net zero" }
  - { value: "0%", label: "Minimum reduction for carbon neutral" }
  - { value: "SBTi", label: "Primary net zero standard-setter" }
  - { value: "Active", label: "Regulatory enforcement of claims" }
seeAlso:
  - { title: "Carbon Offsets", category: "Instruments", description: "The mechanism that enables carbon neutrality, and where greenwashing risk is highest.", slug: "carbon-offsets" }
  - { title: "Greenwashing", category: "Concepts", description: "Misleading environmental claims, the net zero vs carbon neutral gap is a common flashpoint.", slug: "greenwashing" }
  - { title: "Science Based Targets Initiative", category: "Frameworks", description: "The primary standard-setter for credible corporate net zero definitions.", slug: "science-based-targets-initiative" }
  - { title: "GHG Scopes", category: "Concepts", description: "The emissions accounting framework that defines what must be reduced under net zero.", slug: "ghg-scopes" }
  - { title: "Climate Litigation", category: "Concepts", description: "Legal challenges to unsubstantiated net zero and carbon neutral claims.", slug: "climate-litigation" }
unexpected:
...
Net zero means something fundamentally different. A net zero commitment requires the company to first reduce its direct and value-chain emissions as deeply as possible, to near zero across all [[GHG Scopes|scopes]]. Offsets are only used for a small residual of "hard-to-abate" emissions that genuinely cannot be eliminated with current technology. The order matters: reduce first, offset last, and only offset what you truly cannot cut.
