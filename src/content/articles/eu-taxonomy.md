...
type: "article"
stats:
  - { value: "July 2020", label: "Regulation in force" }
  - { value: "6", label: "Environmental objectives" }
  - { value: "3-part", label: "Alignment test" }
  - { value: "GAR", label: "Key bank KPI" }
seeAlso:
  - { title: "CSRD", category: "Frameworks", description: "The directive requiring companies to report taxonomy-alignment KPIs.", slug: "csrd" }
  - { title: "SFDR", category: "Frameworks", description: "The regulation that uses taxonomy alignment to classify investment products.", slug: "sfdr" }
  - { title: "Green Bonds", category: "Instruments", description: "The debt instruments whose EU standard requires full taxonomy alignment.", slug: "green-bonds" }
  - { title: "EU Green Deal", category: "Frameworks", description: "The overarching strategy the Taxonomy serves.", slug: "eu-green-deal" }
  - { title: "Greenwashing", category: "Concepts", description: "The risk the Taxonomy was designed to prevent.", slug: "greenwashing" }
unexpected:
