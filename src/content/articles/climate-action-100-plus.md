...
subtitle: "An investor coalition that targets the world's largest corporate emitters, not to exclude them from portfolios, but to change how they operate from the inside."
category: "actors"
type: "article"
stats:
  - { value: "2017", label: "Launched" }
  - { value: "~150", label: "Focus-list companies" }
  - { value: "5", label: "Coordinating investor networks" }
  - { value: "NZCB", label: "Net Zero Company Benchmark" }
seeAlso:
  - { title: "Transition Pathway Initiative", category: "Actors", description: "Provides carbon performance data used in CA100+ assessments.", slug: "transition-pathway-initiative" }
  - { title: "CDP", category: "Actors", description: "Disclosure data that feeds into the Net Zero Company Benchmark.", slug: "cdp" }
  - { title: "Science Based Targets Initiative", category: "Actors", description: "The credibility standard against which CA100+ engagement asks are measured.", slug: "science-based-targets-initiative" }
  - { title: "TCFD", category: "Frameworks", description: "The disclosure framework CA100+ asks companies to align with.", slug: "tcfd" }
  - { title: "Paris Agreement", category: "Frameworks", description: "The treaty whose goals drive the initiative's engagement agenda.", slug: "paris-agreement" }
  - { title: "Stranded Assets", category: "Concepts", description: "The risk that adds urgency to the engagement-vs-divestment debate.", slug: "stranded-assets" }
unexpected:
