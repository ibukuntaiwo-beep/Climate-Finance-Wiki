...
type: "article"
stats:
  - { value: "Dec 1997", label: "Adopted" }
  - { value: "Feb 2005", label: "Entered into force" }
  - { value: "3", label: "Market mechanisms created" }
  - { value: "95-0", label: "US Senate vote against ratification" }
seeAlso:
  - { title: "Paris Agreement", category: "Frameworks", description: "The successor treaty that fixed Kyoto's developed-country-only flaw.", slug: "paris-agreement" }
  - { title: "UNFCCC and COP", category: "Actors", description: "The international architecture under which Kyoto was negotiated.", slug: "unfccc-and-cop" }
  - { title: "Article 6", category: "Frameworks", description: "The Paris Agreement mechanism that succeeded Kyoto's CDM.", slug: "article-6" }
  - { title: "Carbon Offsets", category: "Instruments", description: "The crediting instruments Kyoto's CDM pioneered at global scale.", slug: "carbon-offsets" }
  - { title: "Cap-and-Trade", category: "Instruments", description: "The market mechanism Kyoto demonstrated between nations.", slug: "cap-and-trade" }
unexpected:
