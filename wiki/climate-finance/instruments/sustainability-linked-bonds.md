...
> Bonds whose financial terms — typically the interest rate — change depending on whether the issuer hits pre-agreed sustainability targets.
...
- SLB proceeds are unrestricted — unlike green bonds, the money can be used for any purpose
- Financial terms (typically the coupon rate) step up if sustainability targets are missed
- Coupon step-ups are typically 25 basis points, though structures vary
- Governed by the Sustainability-Linked Bond Principles (SLBP), administered by ICMA
- Five pillars: KPI selection, target calibration, financial characteristics, reporting, third-party verification
- "Greenrinsing" — setting unambiguously weak targets — is the primary greenwashing risk
- SLBs are particularly suited to high-emitting companies in transition, including those ineligible for green bond proceeds
