...
> The lower yield — and therefore lower borrowing cost — that green bond issuers enjoy compared to equivalent conventional bonds from the same issuer.
...
- The greenium = the yield difference between a green bond and an equivalent conventional bond from the same issuer
- Lower yield = lower borrowing cost for the issuer; investors accept a slightly smaller return
- Estimated magnitude: typically 0–20 basis points; stronger in euro-denominated and European markets
- Driven by concentrated demand from ESG-mandated institutional investors
- Evidence is mixed but persistent, particularly in the EU
- The greenium signals that markets are beginning to price climate alignment into the cost of capital
- A credible green label is a prerequisite — greenwashing destroys the reputational and financial benefit
- A "brown discount" — higher borrowing costs for high-carbon issuers — is an emerging parallel phenomenon
