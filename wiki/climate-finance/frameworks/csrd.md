...
> The Corporate Sustainability Reporting Directive — the EU law that made comprehensive sustainability reporting mandatory for large companies and introduced the principle that companies must account for both how climate affects them and how they affect climate.
...
Under ESRS, companies report across a full range of sustainability topics. The most detailed standards cover climate — requiring disclosure of [[GHG Scopes|Scope 1, 2, and 3 emissions]], transition plans, scenario analysis, and [[EU Taxonomy]]-alignment KPIs (revenue, CapEx, OpEx). ESRS also cover biodiversity, water, circular economy, workforce, supply chain, governance, and business conduct.
...
The CSRD applies in phases based on company size and type. The largest companies (those previously under NFRD, typically with 500+ employees) began reporting for financial year 2024, with first reports due in 2025. Large companies not previously under NFRD (250+ employees, €40M+ turnover, or €20M+ balance sheet) report from FY2025. SMEs listed on EU-regulated markets follow from FY2026. Non-EU companies with significant EU operations (€150M+ net turnover in EU) face obligations from FY2028.
...
- Adopted: December 2022; effective from FY2024 (phased)
- Replaces: Non-Financial Reporting Directive (NFRD)
- Scope: ~50,000 companies (vs ~11,000 under NFRD)
- Reporting standards: European Sustainability Reporting Standards (ESRS), developed by EFRAG
- Key concept: double materiality (financial + impact materiality)
- Requires: third-party limited assurance
- Climate disclosures include: Scope 1, 2, 3 emissions, transition plans, scenario analysis, EU Taxonomy KPIs
- Non-EU companies in scope if: €150M+ EU net turnover and at least one EU subsidiary/branch meeting thresholds (from FY2028)
- Distinct from ISSB: uses double materiality vs ISSB's single (financial) materiality
