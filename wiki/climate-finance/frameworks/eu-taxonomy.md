...
> The European Union's official classification system that defines which economic activities count as environmentally sustainable — the legal backbone of green finance in Europe.
...
- Legal basis: EU Taxonomy Regulation (Regulation 2020/852), in force July 2020
- Six environmental objectives: climate mitigation, climate adaptation, water, circular economy, pollution, biodiversity
- Three-part test: substantial contribution + do no significant harm (DNSH) + minimum social safeguards
- Delegated acts set Technical Screening Criteria (TSC) for each sector/activity
- Gas and nuclear included as taxonomy-aligned under specific conditions (2022 delegated act)
- KPIs: companies report % of revenue, CapEx, OpEx that is taxonomy-aligned
- For banks: Green Asset Ratio (GAR) is the primary KPI
- Underpins SFDR, CSRD, and green bond standards in Europe
