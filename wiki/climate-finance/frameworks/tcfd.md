...
> The Task Force on Climate-related Financial Disclosures — the framework that made climate risk a mainstream concern in global finance, and the template for almost every disclosure standard that followed.
...
- Established: 2015 by the FSB, chaired by Mark Carney
- Recommendations published: June 2017
- Structure: Four pillars — Governance, Strategy, Risk Management, Metrics & Targets
- Peak supporter count: 4,000+ organisations in 100+ countries
- Dissolved: 2024; work transferred to ISSB / IFRS S2
- Key innovation: introduced scenario analysis and physical/transition risk taxonomy to mainstream corporate disclosure
- Mandatory adoption: required in UK, New Zealand, Switzerland, Hong Kong, Japan (among others)

## See Also

- [[IFRS S1 and S2]]
- [[Mark Carney and the Tragedy of the Horizon]]
- [[Physical Risks]]
- [[Transition Risks]]
- [[GHG Scopes]]
