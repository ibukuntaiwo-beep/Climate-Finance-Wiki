...
- Launched: 2017
- Focus list: approximately 150 companies — the world's largest corporate GHG emitters
- Coordinating networks: AIGCC, Ceres, IGCC, IIGCC, PRI
- Primary tool: Net Zero Company Benchmark (NZCB)
- Strategy: shareholder engagement rather than divestment
- Draws on data from CDP, TPI, and other public disclosure sources
- Has faced political headwinds in the US, with some signatories scaling back involvement
