...
- Key multilateral DFIs: World Bank Group (IFC), European Investment Bank, African Development Bank, Asian Development Bank, Inter-American Development Bank
- Key bilateral DFIs: KfW (Germany), Proparco (France), British International Investment (UK), US DFC
- Core mechanism: blended finance — using concessional public capital to mobilise private investment
- Copenhagen pledge: $100 billion/year from developed to developing countries — not met by original 2020 deadline
- EIB committed to 50% of financing directed to climate action by 2025
- DFIs are primary channels for tracking developed-country climate finance contributions to developing nations
