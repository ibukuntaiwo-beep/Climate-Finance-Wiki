...
CDP does not operate in isolation. It is a founding partner of the [[Science Based Targets Initiative]], alongside the UN Global Compact, the World Resources Institute, and WWF. SBTi-validated targets feature in CDP's scoring — companies with approved science-based targets score higher. This creates a virtuous loop: the same companies that engage seriously with one framework tend to engage with others.
...
- Founded: 2000 (as Carbon Disclosure Project; rebranded to CDP)
- Headquarters: London
- Scope: Companies, cities, states, and regions in 90+ countries
- 2022: 680+ financial institutions used CDP to request corporate disclosure
- Grading scale: A (leadership) to D (disclosure) to F (non-disclosure)
- Covers three themes: climate change, forests, water security
- Aligned with TCFD, ISSB/IFRS S1 and S2 frameworks
- Founding partner of the Science Based Targets Initiative
